...
audio_path_original = glob.glob(os.path.dirname(hp.unprocessed_data))      # folders for ids
with open('/home/user/on_gpu/Speaeker_Verification/create_audio_path_vox_lbr/audio_path_other.pkl', 'rb') as pkl_file:
    audio_path = p.load(pkl_file)
...
def save_spectrogram_tisv():
    ...
    for i, folder in enumerate(audio_path[70:]):
